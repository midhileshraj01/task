                          ...
                          child: Container(
                            ...
                            child: ListTile(
                              ...
                              subtitle: Column(
                                ...
                                children: [
                                  Text('Price: \$${snapshot.data![index].price}',style: const TextStyle(),),
                                  StarRating(rating: snapshot.data![index].rating)
                                ],
                              ),
                              leading: Image.network(snapshot.data![index].thumbnail,height: 120,width: 80,fit: BoxFit.fill,),
                            ),
                          ),
                        ),
                      );
